...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	wp_enqueue_script( 'datatables-script', get_template_directory_uri() . '/assets/javascript/custom/DataTables/datatables.min.js', array('jquery'), '5.5.2', true );
	wp_enqueue_style( 'datatables-stylesheet', get_stylesheet_directory_uri() . '/assets/javascript/custom/DataTables/datatables.min.css' , true);
